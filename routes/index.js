...
const stripe = require("stripe")(
  "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"
);
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  const taxPercentage = 0.07; // 4% tax rate
